                            ...
                            <VStack align="start" gap={2}>
                                ...
                                <Flex w="100%" justify="space-between" align="center">
                                    <Text fontSize="sm" color="gray.500">
                                        {formatDate(clinic.date)} • {formatTime(clinic.startTime)} - {formatTime(clinic.endTime)}
                                    </Text>
                                    <Text fontSize="sm" color="gray.500">
                                ...
                                <HStack gap={2} mt={1}>
                                    {clinic.tags?.map((t) => (
                                        <Tag.Root key={t.id} size="md" borderRadius="md" border="0.5px solid" borderColor="gray.200" bg="gray.100" px={2} py={1}>
                                            <Tag.Label fontSize="xs" fontWeight="medium">{t.tag}</Tag.Label>
                                        </Tag.Root>
                                    ))}
                                </HStack>
                            </VStack>
