        ...
        <Table.Body>
          {pageSlice.map((volunteer) => (
            ...
            >
              ...
              <Table.Cell>
                <Text fontSize="sm" color="gray.600">{volunteer.reactivation ?? "—"}</Text>
              </Table.Cell>
              <Table.Cell>
                <Text fontSize="sm" color="gray.600">{volunteer.archivedDate ?? "—"}</Text>
              </Table.Cell>
              <Table.Cell>
                <Text fontSize="sm" color="gray.600">{volunteer.archivedNotes ?? "—"}</Text>
              </Table.Cell>
            </Table.Row>
          ))}
        </Table.Body>
